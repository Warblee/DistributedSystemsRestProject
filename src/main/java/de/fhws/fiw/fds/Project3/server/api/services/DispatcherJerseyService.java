...
import de.fhws.fiw.fds.Project3.server.api.states.dispatcher.GetDispatcher;
import de.fhws.fiw.fds.Project3.server.database.utils.InitializeDatabase;
import de.fhws.fiw.fds.Project3.server.database.utils.ResetDatabase;
...
public class DispatcherJerseyService extends AbstractJerseyService {
    ...
    public Response initializeDatabase() {
        ...
        InitializeDatabase.initializeDB();
        return Response.ok().build();
    }
}
